...
describe("async actions", () => {
    ...
    describe("loadUserRepositories", () => {
        it("should dispatch RECEIVE_USER_REPOSITORIES action, when user repositories be received", () => {
            ...
            const expectedAction = [{type: constants.RECEIVE_USER_REPOSITORIES, repos: repos}];
            const initState = {};
    ...
    describe("fetchIssues", () => {
        it('should dispatch RECEIVE_ISSUES action, when issues be received', () => {
            ...
            const store = mockStore({});
            const expectedActions = [{type: constants.RECEIVE_ISSUES, issues: body.map(mapGithubIssueToLocalIssue)}];
    ...
    describe("fetchIssue", () => {
        it('should dispatch RECEIVE_ISSUES action, when issues be received', () => {
            ...
            const store = mockStore({});
            const expectedActions = [{type: constants.RECEIVE_ISSUES, issues: [mapGithubIssueToLocalIssue(body)]}];

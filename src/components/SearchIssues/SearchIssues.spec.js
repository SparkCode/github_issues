...
describe("<SearchIssues/>", () => {
    ...
    it("should call onSearch callback when form be submited", () => {
        ...
        expect(props.onSearch.calledOnce
            && props.onSearch.calledWithExactly(state.userName, state.repoName, state.issuesCount))
            .toBeTruthy();
    });
    ...
    it("should call onSearch callback when repository is selected", () => {
        ...
        expect(props.onSearch.calledOnce
            && props.onSearch.calledWithExactly(state.userName, selectedRepo, state.issuesCount))
            .toBeTruthy();
    });
    ...
    it("should call searchReposByUserName callback on user name field blur", () => {
        ...
        expect(props.searchReposByUserName.calledOnce
